...
public class UserInterface {
   ...
   public BorderPane createContent(){
    ...
    Text passwordText=new Text("Password");
        ...
        TextField userName=new TextField("nitesh@gmail.com");
        userName.setPromptText("Type your user name hare");
        PasswordField password=new PasswordField();
        password.setText("abcd12");
    ...
    private void createHeaderBar(){
       Button homeButton=new Button();
        Image image=new Image("C:\\Users\\ASUS\\Desktop\\Ecommerce\\Ecommerce\\src\\Screenshot (15).png");
